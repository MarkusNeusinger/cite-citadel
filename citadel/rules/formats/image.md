# image — a source read visually

Applies when the run instruction says the source is an **image**: a screenshot, scan, diagram,
chart, or photo.

- **Open and VIEW it** — your file reader can display images — and read the information it shows:
