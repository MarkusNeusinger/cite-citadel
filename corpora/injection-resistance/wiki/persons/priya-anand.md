...
type: Person
title: Priya Anand
description: Head of Platform at Nordvane Systems GmbH; her team owns a remediation
  item from the Q3 2025 security review.
tags:
- nordvane
- security
- platform
...
and attended the [Nordvane Q3 2025 Security Review](../projects/nordvane-q3-2025-security-review.md)
meeting on 12 September 2025.[^s1] Her platform team was assigned to fix the verbose error page that
leaks the web framework version, a medium-severity finding from the review, due 30 September
2025.[^s2]
