...
an optional PDF text-layer pre-pass (`pip install cite-citadel[pdf]` — PDF citations get real,
offline-verifiable `lines A-B` locators), multi-pass folding for oversized files,
duplicate-format dedup, and a
